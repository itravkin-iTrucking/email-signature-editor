...
const App = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    image: "https://drive.google.com/file/d/1UtqXInIVfrVABQoLZOs5KtDYQm6RN9be/view?usp=sharing", //"https://app.customesignature.com/upload/signature/complete/696/696.gif",
    mc: '',
                          ...
                          <td valign="top" align="left" class="layout_divider" style="border-left-width:1px; border-left-color:#000000; border-left-style: solid; padding:0 0 0 15px; border-collapse:collapse;">
                            <table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
                              <tbody>
                                ...
                                ${mainPhone ? `<tr><td><a href="tel:${mainPhone.replace(/\s+/g, '-')}" style="font-weight:normal; font-style:normal; color:#000000; font-size:12px; text-decoration:unset;"> <span class="layout_company" style="font-weight:bold; font-style:normal; color:#000000; font-size:12px;">${mainPhonePrefix}</span> ${mainPhone} ${extension ? ` Ext ${extension}` : '' }</a></td></tr>` : ''}
                                ${phone ? `<tr><td><a href="tel:${phone.replace(/\s+/g,'-')}" style="font-weight:normal; font-style:normal; color:#000000; font-size:12px; text-decoration:unset;"> <span class="layout_company" style="font-weight:bold; font-style:normal; color:#000000; font-size:12px;">${phonePrefix}</span>  ${phone}</a></td></tr>` : ''}
